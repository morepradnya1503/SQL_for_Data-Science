...
SELECT COUNT(*)
FROM Customers
WHERE [FirstName, PostalCode, Company, Fax, Phone, Address] IS NULL
...
-- Q6) Create a new customer invoice id by combining a customer’s invoice id with their first and last name while ordering your query in the order: firstname, lastname, and invoiceID.
